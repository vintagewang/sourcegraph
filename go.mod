...
require (
	...
	github.com/graph-gophers/graphql-go v0.0.0-20190614164724-8f92f34fc598
...
replace (
	github.com/google/zoekt => github.com/sourcegraph/zoekt v0.0.0-20190612162303-e59a05433315
